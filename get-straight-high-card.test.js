...
describe('getStraightHighCard', () => {
  ...
  test('for a non-straight hand, expect null return', () => {
    ...
    const hand = { cards: [jackOfDiamonds, tenOfClubs, nineOfHearts, eightOfSpades, sixOfSpades]};
  ...
  test('for an Ace to Five straight, expect `Five` returned', () => {
    ...
    const hand = { cards: [treOfDiamonds, fiveOfSpades, fourOfClubs, deuceOfClubs, aceOfHearts]};
  ...
  test('for a straight hand, expect high rank returned', () => {
    ...
    const hand = { cards: [nineOfHearts, eightOfSpades, sevenOfSpades, jackOfDiamonds, tenOfClubs]};
